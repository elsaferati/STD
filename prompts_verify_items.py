...
def _build_porta_verify_items_instructions() -> str:
    return (
        ...
        "4) If an item block contains 'bestehend aus je:', interpret it as a component-only block.\n"
        ...
        "5) Preserve leading zeros and uppercase exactly.\n"
        "6) Preserve O vs 0 exactly as seen (do not normalize).\n"
        "7) Do not keep combined token in one field when it clearly splits.\n"
        "8) If no other valid code patterns or tokens exist in the item block, "
