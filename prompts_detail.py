...
def build_detail_user_instructions() -> str:
    ...
    return (
        ...
        "\n"
        "Use PDF extracted text ONLY to confirm/correct:\n"
        "- articles[*].article_id\n"
        "\n"
        "Do NOT use PDF extracted text to determine quantities.\n"
        "Read quantity from the IMAGE table.\n"
        "\n"
        "Confusable characters rule:\n"
        "- Distinguish letter 'O' vs digit '0'. Some codes contain both (example: OJ00).\n"
        "- When PDF extracted text is available, copy article_id characters exactly from that text.\n"
        "\n"
        "=== WHAT TO EXTRACT ===\n"
        "\n"
        ...
        "  \n"
        "  CRITICAL - Distinguish letter O vs digit 0:\n"
        "  Some article_id values contain BOTH characters (example: OJ00-13200).\n"
        "  When PDF extracted text is available, copy article_id exactly from that text.\n"
        "\n"
