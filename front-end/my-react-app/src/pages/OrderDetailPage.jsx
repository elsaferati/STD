...
export function OrderDetailPage() {
  ...
  if (loading) {
    return (
      <AppShell>
        <div className="min-h-[50vh] flex items-center justify-center text-slate-600">Loading order...</div>
      </AppShell>
    );
  }
  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <section className="bg-surface-light border border-slate-200 rounded-xl p-5 shadow-sm">
