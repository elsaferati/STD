...
export function OverviewPage() {
  ...
  return (
    <div className="bg-background-light text-slate-800 font-display min-h-screen flex flex-col">
      <header className="bg-surface-light border-b border-slate-200 sticky top-0 z-30">
        <div className="max-w-[1600px] mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight">XXLUTZ Operations Control</h1>
      ...
      <main className="flex-1 max-w-[1600px] mx-auto w-full p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-light rounded-xl border border-slate-200 p-6 shadow-sm flex flex-col">
            <div className="flex items-center justify-between mb-6">
              <div>
            ...
            <div className="relative flex-1 w-full min-h-[180px] rounded-lg border border-slate-100 p-2">
