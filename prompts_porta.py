...
def build_user_instructions_porta(source_priority: list[str]) -> str:
    return (
        ...
        "10) If no other valid code patterns or tokens exist in the item block (excluding the OJ/0J model-only fallback above), "
        ...
        "store_address:\n"
        "- ONLY from the 'Verkaufshaus' footer block.\n"
        "- If the Verkaufshaus block is missing, leave store_address empty.\n"
        "- NEVER copy delivery address into store_address.\n"
