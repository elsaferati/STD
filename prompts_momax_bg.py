...
def build_user_instructions_momax_bg(source_priority: list[str]) -> str:
    return (
        ...
        "  Header: ticket_number, kundennummer, adressnummer, kom_nr, kom_name, liefertermin, wunschtermin, bestelldatum, lieferanschrift, tour, store_name, store_address, seller, iln_anl, iln_fil, mail_to, human_review_needed, reply_needed, post_case\n"
        "  mail_to: Always set to empty string '' for this client type.\n"
