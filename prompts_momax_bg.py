...
def build_user_instructions_momax_bg(source_priority: list[str]) -> str:
    return (
        ...
        "   - If the last segment is wrapped with a space/newline (example: '.../180 98'),\n"
        "     merge digits into one article: artikelnummer='18098'.\n"
        "   - Examples:\n"
        "     - 'ZB99/76403' -> modellnummer='ZB99', artikelnummer='76403'\n"
        "     - 'SN/SN/71/SP/91/181' -> modellnummer='SNSN71SP91', artikelnummer='181'\n"
        "     - 'SN/SN/71/SP/91/180 98' -> modellnummer='SNSN71SP91', artikelnummer='18098'\n"
