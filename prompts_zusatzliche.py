...
def build_user_instructions(source_priority: list[str]) -> str:
    return (
        ...
        "  Header: ticket_number, kundennummer, adressnummer, kom_nr, kom_name, liefertermin, wunschtermin, bestelldatum, lieferanschrift, tour, store_name, store_address, seller, iln_anl, iln_fil, mail_to\n"
        ...
        "- 'mailto:<email>' line in the email body letterhead → mail_to = the email address (strip the 'mailto:' prefix, e.g., 'mailto:shop@moebelix.at' → mail_to = 'shop@moebelix.at')\n"
        "- If no 'mailto:' line found, leave mail_to empty with low confidence.\n"
        "\n"
        ...
        "- If TYP value is a multi-hyphen code whose LAST segment is 5 digits (optionally\n"
        "  followed by 1 letter), split it:\n"
        "    → artikelnummer = last hyphen-segment (the 5-digit+optional-letter part)\n"
        "    → modellnummer  = everything before the last hyphen\n"
        "  Strip hyphens from the modellnummer prefix part.\n"
        "  Examples:\n"
        "  - 'TYP:JO-S9-81-AW-AW-15156' → artikelnummer='15156', modellnummer='JOS981AWAW'\n"
        "  - 'TYP:AB-CD-EF-12345G'      → artikelnummer='12345G', modellnummer='ABCDEF'\n"
        "  - 'TYP:54434'                → artikelnummer='54434', modellnummer=null (no split needed)\n"
        "\n"
        ...
        "\n"
        "### ARTIKELNR.: STANDALONE LINES (JOOP / XXXLutz accessory items):\n"
        "CRITICAL DISTINCTION between two patterns that look similar:\n"
        "- '(ArtNr: 05310150/06)' → in PARENTHESES, abbreviated 'ArtNr:' → INTERNAL STORE REF → IGNORE\n"
        "- 'ARTIKELNR.: JO99-72003' → STANDALONE LINE, full 'ARTIKELNR.:' → REAL PRODUCT ITEM → EXTRACT\n"
        "\n"
        "When the email body contains standalone 'ARTIKELNR.:' lines (not wrapped in parentheses),\n"
        "each such line is a SEPARATE ORDER ITEM. Apply the standard hyphenated code split rule:\n"
        "  'ARTIKELNR.: JO99-72003' → artikelnummer='72003', modellnummer='JO99'\n"
        "  'ARTIKELNR.: JO99-31382' → artikelnummer='31382', modellnummer='JO99'\n"
        "  'ARTIKELNR.: JO00-11135' → artikelnummer='11135', modellnummer='JO00'\n"
        "  'ARTIKELNR.: JO00-85543' → artikelnummer='85543', modellnummer='JO00'\n"
        "Only extract if the numeric part matches \\d{5}[A-Z]? (5-digit pattern). Ignore 10-digit values.\n"
        "If a quantity prefix is present (e.g., '2X'), use it as menge.\n"
        "\n"
        ...
        "\n"
        "### ARTIKELNUMMER VALIDATION (ALL XXLUTZ/MÖMAX formats):\n"
        "artikelnummer MUST be exactly 5 digits, OR 5 digits followed by exactly 1 letter.\n"
        "Valid: '15156', '60951', '70594G', '54434'\n"
        "NEVER return a full compound code like 'JO-S9-81-AW-AW-15156' as artikelnummer.\n"
        "If the extracted value does not match this pattern, re-apply the split rule above.\n"
        "\n"
        ...
        "HOW TO HANDLE:\n"
        "- ALWAYS combine all commission numbers in compact form: 'KJNITY-1/2/3/4'\n"
        "- NEVER repeat the base prefix: 'KJNITY-1/2/3' NOT 'KJNITY-1/KJNITY-2/KJNITY-3'\n"
        ...
        "12. CRITICAL - Distinguish letter O vs digit 0 in article codes:\n"
        "    Some codes contain BOTH characters (example: OJ00).\n"
        "    When PDF extracted text is available for a page, copy code characters exactly from that text.\n"
